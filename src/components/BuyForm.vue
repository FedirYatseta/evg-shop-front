<template>
  <div class="p-2 md:p-12 bg-white w-full flex flex-col h-full overflow-auto">
    <div class="text-xl font-bold border-b border-brown-50 py-5">Корзина замовлень</div>
      ...
      <div class="px-2 relative w-full flex flex-col">
        ...
        <div class="flex items-center">
          <div class="grid grid-cols-3 gap-2 items-center justify-items-center">
            <my-button
              class="cursor-pointer w-5 h-5 md:w-7 md:h-7 p-0 bg-brown-100 text-white text-xl text-center rounded-full leading-4"
          ...
          <div class="flex px-2">
            ...
            >
              <p class="text-black-200 text-lg md:text-lg">{{ item.oldPrice }} UAH</p>
            </span>
    ...
    <form @submit.prevent @submit="onSubmit">
      <div class="my-2">
        ...
        <my-input
          ...
          name="name"
          id="name"
          class="border border-solid border-brown w-full h-12"
        />
